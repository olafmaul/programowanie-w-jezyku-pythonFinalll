class Property:
   ...
   def __str__(self):
       return (f"Nieruchomość: Adres: {self.address}, Powierzchnia: {self.area} m², "
...
class House(Property):
   ...
   def __str__(self):
       return (f"DOM: Adres: {self.address}, Powierzchnia: {self.area} m², "
...
class Flat(Property):
   ...
   def __str__(self):
       return (f"MIESZKANIE: Adres: {self.address}, Powierzchnia: {self.area} m², "
               f"Pokoje: {self.rooms}, Cena: {self.price} PLN, "
               f"Piętro: {self.floor},"
               f"Data publikacji: {self.data_publikacji}")
